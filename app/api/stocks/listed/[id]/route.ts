...
// PUT: Update a listed stock using UpdateStockDirectory procedure
export async function PUT(
  ...
  try {
    ...
    if (!countryId || !investmentType || !isin || !stockName || !faceValue || !symbol) {
      return NextResponse.json(
        {
          success: false,
          error: "Missing required fields",
          message: "Country, Investment Type, ISIN, Stock Name, Face Value, and Symbol are required",
        },
        { status: 400 }
      );
    }
